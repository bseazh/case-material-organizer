---
name: lawyerbuddy
description: 面向律师的法律工作总入口。用于案件材料分类归档、案件总结、关键时间轴、类案检索、法律文书起草和合同审查，并按任务路由到对应的 LawyerBuddy 子技能。
---
...
5. 起诉状、答辩状、代理词、律师函或法律意见书：读取 `skills/lawyerbuddy-document-drafting/SKILL.md`。
6. 合同条款、履约、交易或争议风险审查：读取 `skills/lawyerbuddy-contract-review/SKILL.md`。
